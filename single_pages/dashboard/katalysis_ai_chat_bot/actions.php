...
use KatalysisAiChatBot\Search\Actions\Result\Column;
use KatalysisAiChatBot\Search\Actions\Result\Item;
use KatalysisAiChatBot\Search\Actions\Result\ItemColumn;
use KatalysisAiChatBot\Search\Actions\Result\Result;
use KatalysisAiChatBot\Search\Actions\Result\Menu;
use KatalysisAiChatBot\ActionsMenu;
    ...
    (function ($) {
        $(function () {
            ...
            $('#ccm-search-results-table').on('click', 'a[data-id]', function () {
                window.location.href = '<?=rtrim(URL::to('/dashboard/katalysis_ai_chat_bot/actions', 'edit'), '/')?>/' + $(this).attr('data-id');
                return false;
            });
