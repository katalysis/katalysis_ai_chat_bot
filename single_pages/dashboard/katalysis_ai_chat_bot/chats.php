...
use KatalysisAiChatBot\Search\Chats\Result\ItemColumn;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="chats">
        <thead>
            <tr>
                ...
                <?php foreach ($result->getItems() as $item) { ?>
                    ...
                    <tr data-details-url="javascript:void(0)">
                        <td class="ccm-search-results-checkbox">
                            <?php if ($chat instanceof Chat) { ?>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <input data-search-checkbox="individual"
                                    type="checkbox"
                                    data-item-id="<?php echo $chat->getId() ?>"/>
                                <?php } ?>
                            </td>
