...
class AdvancedSearch extends AdvancedSearchController
{
    ...
    {
        return $this->app->make('url')->to('/dashboard/katalysis_ai_chat_bot/chats', 'advanced_search');
    }
    
    public function getSavedSearchBaseURL(SavedSearch $search)
    {
        return $this->app->make('url')->to('/dashboard/katalysis_ai_chat_bot/chats', 'preset', $search->getID());
    }
