...
namespace Concrete\Package\KatalysisAiChatBot\Controller\Dialog\Actions;
...
class AdvancedSearch extends AdvancedSearchController
{
    ...
    {
        return $this->app->make('url')->to('/dashboard/katalysis_ai_chat_bot/actions', 'advanced_search');
    }
    
    public function getSavedSearchBaseURL(SavedSearch $search)
    {
        return $this->app->make('url')->to('/dashboard/katalysis_ai_chat_bot/actions', 'preset', $search->getID());
    }
