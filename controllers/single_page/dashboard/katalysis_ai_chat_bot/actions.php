...
use KatalysisAiChatBot\Entity\Action as ActionEntity;
use KatalysisAiChatBot\Entity\Search\SavedActionsSearch;
use KatalysisAiChatBot\Search\Actions\SearchProvider;
    ...
    */
    ...
    private function save($entry)
    {
        ...
        if ($this->validate($data)) {
            ...
            $this->render("/dashboard/katalysis_ai_chat_bot/actions/edit");
    ...
    public function remove($id = null)
    {
        ...
        if ($entry instanceof ActionEntity) {
            ...
            return $this->responseFactory->redirect(Url::to("/dashboard/katalysis_ai_chat_bot/actions/removed"), Response::HTTP_TEMPORARY_REDIRECT);
        } else {
            $this->responseFactory->notFound(null)->send();
            $this->app->shutdown();
        }
    ...
    protected function getHeaderMenu()
    {
        if (!isset($this->headerMenu)) {
            ...
            $this->headerMenu = $elementManager->get('actions/header/menu', Page::getCurrentPage(), [], 'katalysis_ai_chat_bot');
        }
    ...
    protected function getHeaderSearch()
    {
        if (!isset($this->headerSearch)) {
            /** @var ElementManager $elementManager */
            $elementManager = $this->app->make(ElementManager::class);
            $this->headerSearch = $elementManager->get('actions/header/search', Page::getCurrentPage(), [], 'katalysis_ai_chat_bot');
        }
